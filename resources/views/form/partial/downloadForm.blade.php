    ...
    <table width="100">
        ...
        <tr>
            <td colspan="4" align="center" height="35" valign="center">
                <h2 class="htitle">Balaogan National High School</h2> 
                <p class="stitle">Balaogan, Bula,Camarines Sur</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td  height="33" valign="center">&nbsp;&nbsp;&nbsp; <b style="color: #ff0000">{{ $data->tracking_no }}</b></td>
        </tr>
        <tr>
