            ...
            <div class="card card-hero shadow">
              ...
              <div class="card-body">
                <div class="login-brand">
                  <p class="mt-3">Your Pre-Enrollment was successful</p>
                  ...
                  <ul class="list-unstyled list-unstyled-border p-4">
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="media-title">School Contact & Information</div> 
                        </div>
                    </li>
                    <li class="media">
                ...
                <div class="tickets-list">
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          <a href="{{ route('download',$data) }}" class="ticket-item ticket-more btn btn-icon icon-left btn-primary" id="app">
