                        ...
                        <div class="card-body m-1">
                            <form id="sectionForm" autocomplete="off">@csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="grade_level" class="form-select" aria-label="Default select example" required>
                                        <option value="7">7</option>
                                        <option value="8">8</option>
                                        <option value="9">9</option>
                                        <option value="10">10</option>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="class_type" class="form-select" aria-label="Default select example" required>
                                        <option value=""></option>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="teacher_id" class="form-select" aria-label="Default select example" id="mySelect2" required>
                                        <option value=""></option>
