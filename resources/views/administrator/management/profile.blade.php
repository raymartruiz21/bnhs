...
<div class="container-fluid">
    <section class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-12">
                <h3><i class="fas fa-school color-font"></i>&nbsp;&nbsp;School Profile</h3>
            </div>
        </div>
        <hr>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <div id="image-preview" class="image-preview">
                                                    ...
                                                    <input type="file" name="school_logo" id="image-upload" class=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                                    ...
                                    <form id="enrollStatusForm">@csrf
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-8 col-md-8 col-sm-12">
                                                <p><span class="text-danger">*</span>Choose if the you're going to resume or end the enrollment</p>
                        ...
                        {{-- <div class="col-lg-4">
                            <div class="card card-outline card-warning">
                                <div class="card-body">
                                    <p><span class="text-danger">*</span> Back-up all your Data</p>
                                    <a href="backup/run" class="btn btn-block btn-primary">BACK-UP DATABASE</a>
                                </div>
                            </div>
                        </div> --}}
                    </div>
