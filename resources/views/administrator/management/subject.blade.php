                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="shs_indicate_type" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="shs_grade_level">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="shs_strand_id">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="" name="shs_term">
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-2 float-right">
                            <button class="btn btn-info add_subject  text-white"><i class="fas fa-plus icon"></i> Add Senior High Subject</button>
                        </div>
                    </div>
                  </div>
                <div class="card-body">
