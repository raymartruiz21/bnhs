    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2 justify-content-between">
            <div class="col-lg-5 col-md-8">
                <h3>
                    <i class="fab fa-audible color-font"></i>&nbsp;&nbsp;
                    Enrolle's of (Grade {{ Auth::user()->chairman->grade_level }} | BEC Student)
                </h3>
            </div>
                    ...
                    <div class="card card-outline card-warning">
                        <div class="card-body">
                            ...
                            <form id="massSectioningForm">
                                ...
                                <table class="table table-striped" id="tableCurriculum"  style="font-size: 12px;"   >
                                    <thead>
                                        <tr>
                                            <th width="2%"></th>
