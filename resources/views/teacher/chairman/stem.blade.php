    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2 justify-content-between">
            <div class="col-lg-5 col-md-8">
                <h3><i class="fas fa-award color-font"></i>&nbsp;&nbsp; Enrolle's of (Grade {{ Auth::user()->chairman->grade_level }} | STEM Student)
                </h3>
            </div>
                    ...
                    <div class="card card-outline card-warning">
                        <div class="card-body">
                            <form id="massSectioningForm">
                                ...
                                <table class="table table-striped" style="font-size: 12px;" id="tableCurriculum">
                                    <thead >
                                        <tr>
                                            <th width="2%"></th>
